...
public class RPNComputeToolTest {
    ...
    @Test
    public void giveNullValueNumberShouldReturnError() throws Exception {
        expectedEx.expect(RuntimeException.class);
        expectedEx.expectMessage("Given number is null, please check again!");

        RPNComputeTool.plus(null, null);
        RPNComputeTool.minus(null, null);
        RPNComputeTool.multiply(null, null);
        RPNComputeTool.divide(null, null);
    }
